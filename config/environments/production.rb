...
Rails.application.configure do
  ...
  # Active Storage: S3 when AWS env vars set, else local
  config.active_storage.service = (ENV["AWS_ACCESS_KEY_ID"].present? && ENV["AWS_BUCKET"].present?) ? :amazon : :local
  ...
  # Skip http-to-https redirect for /up so Railway's HTTP health checks succeed (SSL terminates at proxy).
